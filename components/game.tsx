...
// ── GYM LEADER TEAMS ──────────────────────────────────────────────────────────
type GymMon = {id:number; name:string; types:string[]; bst:number};
type GymLeader = {name:string; city:string; emoji:string; diff:number; team:GymMon[]};

const ALL_GYMS:{kanto:GymLeader[]; johto:GymLeader[]; hoenn:GymLeader[]} = {
  kanto:[
    {name:"Brock",city:"Pewter City",emoji:"🪨",diff:1,team:[
      {id:74,name:"Geodude",types:["Rock","Ground"],bst:300},
      {id:95,name:"Onix",types:["Rock","Ground"],bst:385},
    ]},
    {name:"Misty",city:"Cerulean City",emoji:"💧",diff:2,team:[
      {id:120,name:"Staryu",types:["Water"],bst:340},
      {id:121,name:"Starmie",types:["Water","Psychic"],bst:520},
    ]},
    {name:"Lt. Surge",city:"Vermilion City",emoji:"⚡",diff:3,team:[
      {id:100,name:"Voltorb",types:["Electric"],bst:330},
      {id:25,name:"Pikachu",types:["Electric"],bst:320},
      {id:26,name:"Raichu",types:["Electric"],bst:485},
    ]},
    {name:"Erika",city:"Celadon City",emoji:"🌿",diff:4,team:[
      {id:71,name:"Victreebel",types:["Grass","Poison"],bst:490},
      {id:114,name:"Tangela",types:["Grass"],bst:435},
      {id:45,name:"Vileplume",types:["Grass","Poison"],bst:490},
    ]},
    {name:"Koga",city:"Fuchsia City",emoji:"☠️",diff:5,team:[
      {id:109,name:"Koffing",types:["Poison"],bst:340},
      {id:89,name:"Muk",types:["Poison"],bst:500},
      {id:109,name:"Koffing",types:["Poison"],bst:340},
      {id:110,name:"Weezing",types:["Poison"],bst:490},
    ]},
    {name:"Sabrina",city:"Saffron City",emoji:"🔮",diff:6,team:[
      {id:64,name:"Kadabra",types:["Psychic"],bst:400},
      {id:122,name:"Mr. Mime",types:["Psychic"],bst:460},
      {id:97,name:"Hypno",types:["Psychic"],bst:483},
      {id:65,name:"Alakazam",types:["Psychic"],bst:500},
    ]},
    {name:"Blaine",city:"Cinnabar Island",emoji:"🌋",diff:7,team:[
      {id:77,name:"Ponyta",types:["Fire"],bst:410},
      {id:78,name:"Rapidash",types:["Fire"],bst:500},
      {id:126,name:"Magmar",types:["Fire"],bst:495},
      {id:6,name:"Charizard",types:["Fire","Flying"],bst:534},
    ]},
    {name:"Giovanni",city:"Viridian City",emoji:"🌍",diff:8,team:[
      {id:111,name:"Rhyhorn",types:["Ground","Rock"],bst:345},
      {id:51,name:"Dugtrio",types:["Ground"],bst:425},
      {id:53,name:"Persian",types:["Normal"],bst:440},
      {id:112,name:"Rhydon",types:["Ground","Rock"],bst:485},
    ]},
    {name:"Lorelei",city:"Elite Four",emoji:"❄️",diff:9,team:[
      {id:87,name:"Dewgong",types:["Water","Ice"],bst:475},
      {id:91,name:"Cloyster",types:["Water","Ice"],bst:525},
      {id:80,name:"Slowbro",types:["Water","Psychic"],bst:490},
      {id:124,name:"Jynx",types:["Ice","Psychic"],bst:455},
      {id:131,name:"Lapras",types:["Water","Ice"],bst:535},
    ]},
    {name:"Bruno",city:"Elite Four",emoji:"👊",diff:9,team:[
      {id:95,name:"Onix",types:["Rock","Ground"],bst:385},
      {id:107,name:"Hitmonchan",types:["Fighting"],bst:455},
      {id:106,name:"Hitmonlee",types:["Fighting"],bst:455},
      {id:95,name:"Onix",types:["Rock","Ground"],bst:385},
      {id:68,name:"Machamp",types:["Fighting"],bst:505},
    ]},
    {name:"Agatha",city:"Elite Four",emoji:"👻",diff:9,team:[
      {id:94,name:"Gengar",types:["Ghost","Poison"],bst:500},
      {id:93,name:"Haunter",types:["Ghost","Poison"],bst:405},
      {id:42,name:"Golbat",types:["Poison","Flying"],bst:455},
      {id:94,name:"Gengar",types:["Ghost","Poison"],bst:500},
      {id:93,name:"Haunter",types:["Ghost","Poison"],bst:405},
    ]},
    {name:"Lance",city:"Elite Four",emoji:"🐉",diff:10,team:[
      {id:130,name:"Gyarados",types:["Water","Flying"],bst:540},
      {id:142,name:"Aerodactyl",types:["Rock","Flying"],bst:515},
      {id:149,name:"Dragonite",types:["Dragon","Flying"],bst:600},
      {id:149,name:"Dragonite",types:["Dragon","Flying"],bst:600},
      {id:149,name:"Dragonite",types:["Dragon","Flying"],bst:600},
    ]},
    {name:"Blue",city:"Champion",emoji:"🏆",diff:10,team:[
      {id:18,name:"Pidgeot",types:["Normal","Flying"],bst:479},
      {id:112,name:"Rhydon",types:["Ground","Rock"],bst:485},
      {id:65,name:"Alakazam",types:["Psychic"],bst:500},
      {id:103,name:"Exeggutor",types:["Grass","Psychic"],bst:530},
      {id:59,name:"Arcanine",types:["Fire"],bst:555},
      {id:9,name:"Blastoise",types:["Water"],bst:530},
    ]},
  ],
  johto:[
    {name:"Falkner",city:"Violet City",emoji:"🦅",diff:1,team:[
      {id:21,name:"Spearow",types:["Normal","Flying"],bst:262},
      {id:18,name:"Pidgeot",types:["Normal","Flying"],bst:479},
    ]},
    {name:"Bugsy",city:"Azalea Town",emoji:"🐛",diff:2,team:[
      {id:13,name:"Weedle",types:["Bug","Poison"],bst:195},
      {id:14,name:"Kakuna",types:["Bug","Poison"],bst:205},
      {id:123,name:"Scyther",types:["Bug","Flying"],bst:500},
    ]},
    {name:"Whitney",city:"Goldenrod City",emoji:"🎀",diff:3,team:[
      {id:35,name:"Clefairy",types:["Normal"],bst:323},
      {id:241,name:"Miltank",types:["Normal"],bst:490},
    ]},
    {name:"Morty",city:"Ecruteak City",emoji:"👻",diff:4,team:[
      {id:92,name:"Gastly",types:["Ghost","Poison"],bst:310},
      {id:93,name:"Haunter",types:["Ghost","Poison"],bst:405},
      {id:93,name:"Haunter",types:["Ghost","Poison"],bst:405},
      {id:94,name:"Gengar",types:["Ghost","Poison"],bst:500},
    ]},
    {name:"Chuck",city:"Cianwood City",emoji:"🥊",diff:5,team:[
      {id:62,name:"Poliwrath",types:["Water","Fighting"],bst:510},
      {id:67,name:"Machoke",types:["Fighting"],bst:405},
    ]},
    {name:"Jasmine",city:"Olivine City",emoji:"⚙️",diff:6,team:[
      {id:81,name:"Magnemite",types:["Electric","Steel"],bst:325},
      {id:81,name:"Magnemite",types:["Electric","Steel"],bst:325},
      {id:208,name:"Steelix",types:["Steel","Ground"],bst:510},
    ]},
    {name:"Pryce",city:"Mahogany Town",emoji:"🧊",diff:7,team:[
      {id:86,name:"Seel",types:["Water"],bst:325},
      {id:87,name:"Dewgong",types:["Water","Ice"],bst:475},
      {id:221,name:"Piloswine",types:["Ice","Ground"],bst:450},
    ]},
    {name:"Clair",city:"Blackthorn City",emoji:"🐲",diff:8,team:[
      {id:148,name:"Dragonair",types:["Dragon"],bst:420},
      {id:148,name:"Dragonair",types:["Dragon"],bst:420},
      {id:148,name:"Dragonair",types:["Dragon"],bst:420},
      {id:230,name:"Kingdra",types:["Water","Dragon"],bst:540},
    ]},
    {name:"Will",city:"Elite Four",emoji:"🔮",diff:9,team:[
      {id:178,name:"Xatu",types:["Psychic","Flying"],bst:470},
      {id:124,name:"Jynx",types:["Ice","Psychic"],bst:455},
      {id:178,name:"Xatu",types:["Psychic","Flying"],bst:470},
      {id:196,name:"Espeon",types:["Psychic"],bst:525},
    ]},
    {name:"Koga",city:"Elite Four",emoji:"☠️",diff:9,team:[
      {id:169,name:"Crobat",types:["Poison","Flying"],bst:535},
      {id:200,name:"Misdreavus",types:["Ghost"],bst:435},
      {id:49,name:"Venomoth",types:["Bug","Poison"],bst:450},
      {id:110,name:"Weezing",types:["Poison"],bst:490},
    ]},
    {name:"Bruno",city:"Elite Four",emoji:"👊",diff:9,team:[
      {id:95,name:"Onix",types:["Rock","Ground"],bst:385},
      {id:214,name:"Heracross",types:["Bug","Fighting"],bst:500},
      {id:107,name:"Hitmonchan",types:["Fighting"],bst:455},
      {id:106,name:"Hitmonlee",types:["Fighting"],bst:455},
      {id:68,name:"Machamp",types:["Fighting"],bst:505},
    ]},
    {name:"Karen",city:"Elite Four",emoji:"🌑",diff:9,team:[
      {id:197,name:"Umbreon",types:["Dark"],bst:525},
      {id:229,name:"Houndoom",types:["Dark","Fire"],bst:500},
      {id:198,name:"Murkrow",types:["Dark","Flying"],bst:405},
      {id:248,name:"Tyranitar",types:["Rock","Dark"],bst:600},
    ]},
    {name:"Lance",city:"Champion",emoji:"🏆",diff:10,team:[
      {id:130,name:"Gyarados",types:["Water","Flying"],bst:540},
      {id:149,name:"Dragonite",types:["Dragon","Flying"],bst:600},
      {id:149,name:"Dragonite",types:["Dragon","Flying"],bst:600},
      {id:142,name:"Aerodactyl",types:["Rock","Flying"],bst:515},
  ...
  hoenn:[
    {name:"Roxanne",city:"Rustboro City",emoji:"🪨",diff:1,team:[
      {id:74,name:"Geodude",types:["Rock","Ground"],bst:300},
      {id:74,name:"Geodude",types:["Rock","Ground"],bst:300},
      {id:139,name:"Omastar",types:["Rock","Water"],bst:495},
    ]},
    {name:"Brawly",city:"Dewford Town",emoji:"🥊",diff:2,team:[
      {id:66,name:"Machop",types:["Fighting"],bst:305},
      {id:297,name:"Hariyama",types:["Fighting"],bst:474},
    ]},
    {name:"Wattson",city:"Mauville City",emoji:"⚡",diff:3,team:[
      {id:100,name:"Voltorb",types:["Electric"],bst:330},
      {id:82,name:"Magneton",types:["Electric","Steel"],bst:465},
      {id:310,name:"Manectric",types:["Electric"],bst:475},
    ]},
    {name:"Flannery",city:"Lavaridge Town",emoji:"🔥",diff:4,team:[
      {id:323,name:"Camerupt",types:["Fire","Ground"],bst:460},
      {id:324,name:"Torkoal",types:["Fire"],bst:470},
      {id:78,name:"Rapidash",types:["Fire"],bst:500},
    ]},
    {name:"Norman",city:"Petalburg City",emoji:"🎯",diff:5,team:[
      {id:289,name:"Slaking",types:["Normal"],bst:670},
      {id:128,name:"Tauros",types:["Normal"],bst:490},
      {id:289,name:"Slaking",types:["Normal"],bst:670},
    ]},
    {name:"Winona",city:"Fortree City",emoji:"🦅",diff:6,team:[
      {id:279,name:"Pelipper",types:["Water","Flying"],bst:430},
      {id:334,name:"Altaria",types:["Dragon","Flying"],bst:490},
      {id:277,name:"Swellow",types:["Normal","Flying"],bst:455},
      {id:130,name:"Gyarados",types:["Water","Flying"],bst:540},
    ]},
    {name:"Tate & Liza",city:"Mossdeep City",emoji:"🔮",diff:7,team:[
      {id:344,name:"Claydol",types:["Ground","Psychic"],bst:500},
      {id:354,name:"Banette",types:["Ghost"],bst:455},
      {id:376,name:"Metagross",types:["Steel","Psychic"],bst:600},
      {id:282,name:"Gardevoir",types:["Psychic"],bst:518},
    ]},
    {name:"Juan",city:"Sootopolis City",emoji:"💧",diff:8,team:[
      {id:350,name:"Milotic",types:["Water"],bst:540},
      {id:91,name:"Cloyster",types:["Water","Ice"],bst:525},
      {id:99,name:"Kingler",types:["Water"],bst:475},
      {id:230,name:"Kingdra",types:["Water","Dragon"],bst:540},
    ]},
    {name:"Sidney",city:"Elite Four",emoji:"🌑",diff:9,team:[
      {id:262,name:"Mightyena",types:["Dark"],bst:420},
      {id:359,name:"Absol",types:["Dark"],bst:465},
      {id:332,name:"Cacturne",types:["Grass","Dark"],bst:475},
      {id:319,name:"Sharpedo",types:["Water","Dark"],bst:460},
    ]},
    {name:"Phoebe",city:"Elite Four",emoji:"👻",diff:9,team:[
      {id:354,name:"Banette",types:["Ghost"],bst:455},
      {id:356,name:"Dusclops",types:["Ghost"],bst:455},
      {id:354,name:"Banette",types:["Ghost"],bst:455},
      {id:356,name:"Dusclops",types:["Ghost"],bst:455},
    ]},
    {name:"Glacia",city:"Elite Four",emoji:"❄️",diff:10,team:[
      {id:362,name:"Glalie",types:["Ice"],bst:480},
      {id:365,name:"Walrein",types:["Ice","Water"],bst:530},
      {id:362,name:"Glalie",types:["Ice"],bst:480},
      {id:365,name:"Walrein",types:["Ice","Water"],bst:530},
    ]},
    {name:"Drake",city:"Elite Four",emoji:"🐉",diff:10,team:[
      {id:330,name:"Flygon",types:["Ground","Dragon"],bst:520},
      {id:334,name:"Altaria",types:["Dragon","Flying"],bst:490},
      {id:342,name:"Crawdaunt",types:["Water","Dark"],bst:468},
      {id:373,name:"Salamence",types:["Dragon","Flying"],bst:600},
    ]},
    {name:"Steven",city:"Champion",emoji:"🏆",diff:10,team:[
      {id:227,name:"Skarmory",types:["Steel","Flying"],bst:465},
      {id:306,name:"Aggron",types:["Steel","Rock"],bst:530},
      {id:348,name:"Armaldo",types:["Rock","Bug"],bst:495},
      {id:346,name:"Cradily",types:["Rock","Grass"],bst:495},
      {id:376,name:"Metagross",types:["Steel","Psychic"],bst:600},
    ]},
  ],
};
...
const TYPE_CHART: Record<string,{strong:string[],weak:string[],immune:string[]}> = {
  Fire:    {strong:["Grass","Bug","Ice","Steel"],        weak:["Water","Rock","Ground"],               immune:[]},
  Water:   {strong:["Fire","Rock","Ground"],             weak:["Electric","Grass"],                    immune:[]},
  Grass:   {strong:["Water","Rock","Ground"],            weak:["Fire","Ice","Poison","Flying","Bug"],  immune:[]},
  ...
  Fighting:{strong:["Normal","Rock","Steel","Ice","Dark"],weak:["Flying","Psychic","Fairy"],           immune:["Ghost"]},
  Rock:    {strong:["Flying","Bug","Fire","Ice"],        weak:["Water","Grass","Fighting","Ground","Steel"], immune:[]},
  ...
  Ghost:   {strong:["Ghost","Psychic"],                  weak:["Ghost","Dark"],                        immune:["Normal","Fighting"]},
...
function typeEffectiveness(attackerTypes: string[], defenderTypes: string[]): number {
  ...
  for (const atkType of attackerTypes) {
    ...
    for (const defType of defenderTypes) {
      if (chart.immune.includes(defType)) { bestMult = 0; break; }
...
function teamTypeAdvantage(team: {types:string[]; id:number}[], gymTypes: string[]): number {
  let total = 0;
  for (const mon of team) {
    const offMult = typeEffectiveness(mon.types, gymTypes);
    const defMult = typeEffectiveness(gymTypes, mon.types);
    const monIsImmune = defMult === 0;
    const gymIsImmune = offMult === 0;
    const offScore = gymIsImmune ? -40 : (offMult - 1) * 40;
    const defScore = monIsImmune ? -50 : (defMult - 1) * 35;
...
function legendaryBonus(team: {id:number}[]): number {
  ...
  return count > 0 ? count * 80 - (count - 1) * 5 : 0;
}

// ── POWER RATING ──────────────────────────────────────────────────────────────
function teamPowerRating(team: {id:number; bst:number; types:string[]}[]): number {
  const bstTotal = team.reduce((s,p) => s+p.bst, 0);
  const legBonus = legendaryBonus(team);
  return Math.round(bstTotal + legBonus);
}

function gymPowerRating(leader: GymLeader): number {
  const bstTotal = leader.team.reduce((s,p) => s+p.bst, 0);
  const diffBonus = leader.diff * 50;
  return Math.round(bstTotal + diffBonus);
}

type Pokemon = {id:number; name:string; types:string[]; bst:number};

function battle(team: Pokemon[], leader: GymLeader, rng: (()=>number)|null){
  const gymTypes = [...new Set(leader.team.flatMap(p => p.types))];
  const avgBst = team.reduce((s,p)=>s+p.bst,0)/team.length;
  const typeAdv = teamTypeAdvantage(team, gymTypes);
  const legBonus = legendaryBonus(team);
  const gymAvgBst = leader.team.reduce((s,p)=>s+p.bst,0)/leader.team.length;
  const gymStrength = gymAvgBst * 0.85;
  const teamPower = avgBst + typeAdv + legBonus;
  const raw = 0.5 + (teamPower - gymStrength) / 80;
...
function PowerBadge({pwr,color=C.gold}:{pwr:number,color?:string}){
  return<span style={{background:`${color}18`,border:`1px solid ${color}44`,color,fontSize:"7px",fontWeight:700,padding:"2px 7px",borderRadius:20,fontFamily:C.px,whiteSpace:"nowrap"}}>PWR {pwr.toLocaleString()}</span>;
}
...
function Leaderboard({onClose}:{onClose:()=>void}){
  ...
  const filtered=filterEntries(tab).sort((a,b)=>b.wins-a.wins||a.losses-b.losses||(b.powerRating||0)-(a.powerRating||0)).slice(0,20);
          ...
          <div key={i} style={{display:"flex",alignItems:"center",gap:10,padding:"10px 12px",background:i===0?"rgba(255,215,0,0.06)":C.panel,border:`1px solid ${i===0?"rgba(255,215,0,0.2)":C.border}`,borderRadius:10,marginBottom:6}}>
            ...
            <div style={{flex:1,minWidth:0}}>
              ...
              <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:2}}>
                {e.powerRating&&<PowerBadge pwr={e.powerRating}/>}
              </div>
...
export default function App(){
  ...
  function buildGyms(){
    return [...selRegions].flatMap(r=>ALL_GYMS[r as keyof typeof ALL_GYMS]);
  }
  ...
  async function runBattle(){
    ...
    for(let i=0;i<gyms.length;i++){
      ...
      log.push({leader:gyms[i],...res});setBattleLog([...log]);
      if(res.win)w++;else l++;
    }
  ...
  const myPwr = team.length>0 ? teamPowerRating(team) : 0;
        ...
        {screen==="draft"&&(
          <>
            <div style={{width:"100%",marginTop:16,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
              ...
              <div style={{fontSize:"7px",color:C.dim}}>Gen {genLabel}</div>
            ...
            {team.length>0&&(
              <div style={{width:"100%",marginTop:14}}>
                ...
                {team.length>0&&<div style={{marginTop:8,textAlign:"center"}}><PowerBadge pwr={teamPowerRating(team)}/></div>}
              </div>
            )}
          </>
        )}
        ...
        {screen==="ready"&&(
          <>
            <div style={{width:"100%",display:"flex",gap:6,marginTop:18,flexWrap:"wrap"}}>
              {team.map((p,i)=><div key={i} style={{flex:"1 0 calc(33% - 6px)",display:"flex",flexDirection:"column",alignItems:"center",gap:4,background:C.panel,border:`1px solid ${LEGENDARY_IDS.has(p.id)?"rgba(255,165,0,0.4)":C.border}`,borderRadius:10,padding:"10px 6px",boxShadow:LEGENDARY_IDS.has(p.id)?"0 0 8px rgba(255,165,0,0.15)":"none"}}>
                <Sprite id={p.id} size={56}/>
                <div style={{fontSize:"7px",color:LEGENDARY_IDS.has(p.id)?"#ff9800":C.gold,textAlign:"center"}}>{p.name}</div>
                {LEGENDARY_IDS.has(p.id)&&<div style={{fontSize:"5px",color:"#ff9800",opacity:0.8}}>⚡ LEGENDARY</div>}
                <div style={{display:"flex",gap:2,flexWrap:"wrap",justifyContent:"center"}}>{p.types.map(t=><Pill key={t} type={t}/>)}</div>
                <div style={{fontSize:"6px",color:C.dim}}>BST {p.bst}</div>
              </div>)}
            </div>
            <div style={{marginTop:12,display:"flex",flexDirection:"column",alignItems:"center",gap:8}}>
              <PowerBadge pwr={myPwr}/>
              <div style={{fontSize:"7px",color:C.dim}}>Gen {genLabel} · {regionLabel} · {gyms.length} BATTLES</div>
            </div>
        ...
        {screen==="battle"&&(
          <Card style={{marginTop:20}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
              <div style={{fontSize:"8px",color:C.gold}}><span className="blink">▶</span> GYM RUN</div>
              <PowerBadge pwr={myPwr}/>
            </div>
            {battleLog.map((b,i)=>{
              const gymPwr = gymPowerRating(b.leader);
              return(
                <div key={i} style={{marginBottom:10,padding:"8px 0",borderBottom:"1px solid rgba(255,255,255,0.04)"}}>
                  <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
                    <span style={{fontSize:14}}>{b.leader.emoji}</span>
                    <div style={{flex:1}}>
                      <div style={{fontSize:"8px",color:b.win?C.text:C.red}}>{b.leader.name}</div>
                      <div style={{fontSize:"6px",color:C.dim}}>{b.leader.city}</div>
                    </div>
                    <PowerBadge pwr={gymPwr} color={b.win?"#445":C.red}/>
                    <div style={{fontSize:"8px",color:b.win?C.green:C.red,fontWeight:700,width:32,textAlign:"right"}}>{b.win?"WIN":"LOSS"}</div>
                  </div>
                  <div style={{display:"flex",gap:4,flexWrap:"wrap",marginBottom:5}}>
                    {b.leader.team.map((p: GymMon, j: number)=>(
                      <div key={j} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:2}}>
                        <Sprite id={p.id} size={28}/>
                        <div style={{display:"flex",gap:1,flexWrap:"wrap",justifyContent:"center"}}>
                          {p.types.map((t: string)=><Pill key={t} type={t}/>)}
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div style={{fontSize:"6px",color:C.dim,marginTop:3,textAlign:"right"}}>{b.pct}% win chance</div>
                </div>
              );
            })}
            {battleLog.length<gyms.length&&(
              <div style={{textAlign:"center",marginTop:12,fontSize:"7px",color:C.dim}}>
                {gyms[gymIdx]?.emoji} {gyms[gymIdx]?.name}<span className="blink">...</span>
              </div>
            )}
          </Card>
        )}
        ...
        {screen==="result"&&(
          <>
            <div style={{textAlign:"center",marginTop:20}}>
              ...
              <div style={{marginTop:8}}><PowerBadge pwr={myPwr}/></div>
              <div style={{fontSize:"7px",color:C.dim,marginTop:6}}>Gen {genLabel} · {regionLabel}{daily?" · Daily":""}</div>
            </div>
              ...
              <Card>
                <div style={{background:"#050510",border:`1px solid ${won?C.gold:C.red}33`,borderRadius:10,padding:"14px 12px",marginBottom:12}}>
                  ...
                  <div style={{display:"flex",gap:3,marginBottom:12,flexWrap:"wrap"}}>
                    {battleLog.map((b,i)=><div key={i} style={{width:22,height:22,borderRadius:4,background:b.win?C.green:C.red,display:"flex",alignItems:"center",justifyContent:"center",fontSize:10,boxShadow:`0 0 4px ${b.win?C.green:C.red}44`}}>{b.leader.emoji}</div>)}
                  ...
                  <div style={{textAlign:"center",marginBottom:6}}><PowerBadge pwr={myPwr}/></div>
              ...
              <Card>
                {submitted?(
                  <div style={{textAlign:"center",padding:"10px 0"}}>
                    ...
                    <div style={{fontSize:"7px",color:C.dim,marginBottom:8,lineHeight:2}}>
                      {playerName} · {record.w}-{record.l}
                    </div>
                    <div style={{marginBottom:16}}><PowerBadge pwr={myPwr}/></div>
                  ...
                  <>
                    ...
                    <div style={{fontSize:"7px",color:C.dim,marginBottom:8,lineHeight:2}}>{record.w}-{record.l} · Gen {genLabel} · {regionLabel}</div>
                    <div style={{marginBottom:14}}><PowerBadge pwr={myPwr}/></div>
                    <input
                      value={nameInput}
            ...
            {resultTab==="log"&&(
              <Card>
                {battleLog.map((b,i)=>{
                  const gymPwr = gymPowerRating(b.leader);
                  return(
                    <div key={i} style={{marginBottom:12,padding:"8px 0",borderBottom:"1px solid rgba(255,255,255,0.04)"}}>
                      <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
                        <span style={{fontSize:14}}>{b.leader.emoji}</span>
                        <div style={{flex:1}}>
                          <div style={{fontSize:"8px"}}>{b.leader.name}</div>
                          <div style={{fontSize:"6px",color:C.dim}}>{b.leader.city}</div>
                        </div>
                        <PowerBadge pwr={gymPwr} color="#445"/>
                        <div style={{textAlign:"right"}}>
                          <div style={{fontSize:"8px",color:b.win?C.green:C.red,fontWeight:700}}>{b.win?"W":"L"}</div>
                          <div style={{fontSize:"6px",color:C.dim}}>{b.pct}%</div>
                        </div>
                      </div>
                      <div style={{display:"flex",gap:4,flexWrap:"wrap",marginBottom:5}}>
                        {b.leader.team.map((p: GymMon,j: number)=>(
                          <div key={j} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:2}}>
                            ...
                            <div style={{fontSize:"5px",color:C.dim,textAlign:"center",maxWidth:36,overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis"}}>{p.name}</div>
                            <div style={{display:"flex",gap:1,flexWrap:"wrap",justifyContent:"center"}}>{p.types.map((t: string)=><Pill key={t} type={t}/>)}</div>
                            <div style={{fontSize:"5px",color:"#334"}}>BST {p.bst}</div>
                          </div>
                        ))}
                      </div>
                    </div>
